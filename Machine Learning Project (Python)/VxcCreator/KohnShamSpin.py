...
'''
For a detailed description of all neccesaary arguments needed here, look into V_xc_CreatorSpin.py 
For the argument "P" a dictionary is expected containing all the parameters & data describing
a certain physical system
occ = occupation of KS orbitals - e.g. [1,1] means, that the 1st and 2nd (spin-)orbital is occupied once!
'''
...
def Energies(P, Dens, v_ext, v_H, occ):
